    ...
    return (
        ...
        <section className="h-full w-full bg-[#bc360d] px-8 py-6">
            ...
            <div className="flex flex-col gap-6 text-white">
                ...
                <h2 className='mt-2 text-lg flex gap-2 py-2 bg-primary rounded px-2'>
                ...
                <h2 className='text-lg flex gap-2'>
                    ...
                    Events
                </h2><h2 className='text-lg flex gap-2'>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                ...
                <button className='mt-4 flex gap-2 py-3 px-2 bg-primary justify-center rounded'>
                    Sign out
