...
export default function StatCards({ stats }) {
    return (
        <div className='grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-6'>
            <div className='py-5 px-5 bg-green-600 bg-opacity-40 shadow-sm rounded flex gap-4 justify-between'>
                ...
                <div className="grow flex flex-col items-center justify-center font-poppins">
                    <h2>Active Events</h2>
                    <h1 className='text-2xl font-bold pt-2'>20</h1>
                </div>
            </div>


            <div className='py-5 px-5 bg-yellow-600 bg-opacity-25 shadow-sm rounded flex gap-4 justify-between'>
                <div className='h-14 w-14 flex items-center justify-center bg-white rounded-full'>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-7 h-7">
