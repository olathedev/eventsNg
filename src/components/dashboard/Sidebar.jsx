    ...
    return (
        ...
        <section className="h-full w-full bg-[#bc360d] px-8 py-6">
            ...
            <div className="flex flex-col gap-6 text-white">
                ...
                <NavLink to='/dashboard/events' className='text-lg flex gap-2 cursor-pointer hover:translate-x-2 transition duration-200 ease-in-out'>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                ...
                <NavLink to='/dashboard/ticketing' className='text-lg flex gap-2 cursor-pointer hover:translate-x-2 transition duration-200 ease-in-out'>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                ...
                <NavLink to='/dashboard/bookings' className='text-lg flex gap-2 cursor-pointer hover:translate-x-2 transition duration-200 ease-in-out'>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                ...
                <NavLink to='/dashboard/payment' className='text-lg flex gap-2 cursor-pointer hover:translate-x-2 transition duration-200 ease-in-out'>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                ...
                <h2 className='text-lg flex gap-2 cursor-pointer hover:translate-x-2 transition duration-200 ease-in-out'>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
