    ...
    return (
        ...
        <section className="h-full w-full bg-[#bc360d] px-8 py-6">
            ...
            <div className="flex flex-col gap-6 text-white">
                ...
                <h2 className='mt-2 text-lg flex gap-2 py-2 bg-primary rounded px-2 cursor-pointer hover:translate-x-2 transition duration-200 ease-in-out'>
                ...
                </h2><h2 className='text-lg flex gap-2 cursor-pointer hover:translate-x-2 transition duration-200 ease-in-out'>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 6v.75m0 3v.75m0 3v.75m0 3V18m-9-5.25h5.25M7.5 15h3M3.375 5.25c-.621 0-1.125.504-1.125 1.125v3.026a2.999 2.999 0 0 1 0 5.198v3.026c0 .621.504 1.125 1.125 1.125h17.25c.621 0 1.125-.504 1.125-1.125v-3.026a2.999 2.999 0 0 1 0-5.198V6.375c0-.621-.504-1.125-1.125-1.125H3.375Z" />
                    </svg>

                    <NavLink to='/dashboard/ticketing'>
                        Ticketing
