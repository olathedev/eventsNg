    ...
    return (
        <section className="container hero mx-auto hero py-20 px-4 text-white">
            <div className='flex flex-col items-center gap-3 md:gap-4'>
                <div className="bg-[#D3B3EB] bg-opacity-20 border border-primary  text-primary text-sm font-semibold font-monteserat px-4 md:px-6 py-1 md:py-2 rounded-xl flex items-center gap-2">
                ...
                <div className="flex justify-center items-center mt-2 md:mt-4">
                    <h1 className='text-2xl md:text-6xl md:max-w-[70%] text-center font-poppins font-extrabold md:leading-[4.5rem]'> Event listing and ticketing  made easy
