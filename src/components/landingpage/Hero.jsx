    ...
    return (
        <section className="container mx-auto hero mt-10 px-4">
            <div className='flex flex-col items-center gap-3 md:gap-4'>
                <div className="bg-primary text-primary text-sm font-semibold font-monteserat bg-opacity-30 px-4 md:px-6 py-1 md:py-2 rounded-xl flex items-center gap-2">
